...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_header_menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/header-menu */ "./src/js/components/header-menu.js");
/* harmony import */ var _components_header_menu__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_header_menu__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_burger_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/burger-menu */ "./src/js/components/burger-menu.js");
/* harmony import */ var _components_burger_menu__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_burger_menu__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_tippy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/tippy */ "./src/js/components/tippy.js");
...
/* harmony import */ var _components_quantity__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/quantity */ "./src/js/components/quantity.js");
/* harmony import */ var _components_quantity__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_quantity__WEBPACK_IMPORTED_MODULE_4__);
...
var tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_5__["default"]('tab');
...
/* harmony import */ var _vendor_spoller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/spoller */ "./src/js/vendor/spoller.js");
/* harmony import */ var _vendor_spoller__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_spoller__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _vendor_rating__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/rating */ "./src/js/vendor/rating.js");
/* harmony import */ var _vendor_rating__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_rating__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _vendor_range__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/range */ "./src/js/vendor/range.js");
/* harmony import */ var _vendor_dynamicAdapt_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor/dynamicAdapt.js */ "./src/js/vendor/dynamicAdapt.js");





(0,_vendor_dynamicAdapt_js__WEBPACK_IMPORTED_MODULE_4__.useDynamicAdapt)();
...
var menuBlocks = document.querySelectorAll('.sub-menu-catalog__block');

if (menuBlocks.length) {
  menuBlocks.forEach(function (menuBlocks) {
    var menuBlocksItems = menuBlocks.querySelectorAll('.sub-menu-catalog__category').length;
    menuBlocks.classList.add("sub-menu-catalog__block-".concat(menuBlocksItems));
  });
}
...
function documentActions(e) {
  ...
  if (targetElement.closest('[data-parent]')) {
    ...
    if (subMenu) {
      var activeLink = document.querySelector('._sub-menu-active');
      var activeBlock = document.querySelector('._sub-menu-open');
...
var inp = document.querySelector('.quantity__input');
var buttonPlus = document.querySelector('.quantity__button-plus');
var buttonsMinus = document.querySelector('.quantity__button-minus');
var priceValue = document.querySelector('.price-value');
var parsePrice = priceValue.textContent;
parsePrice = parsePrice.replace(/[^0-9]/g, '');
console.log("priceValue.textContent = ".concat(parsePrice));
buttonsMinus.addEventListener('click', function () {
...
var change = function change() {
  var totalPrice = Number(parsePrice) * Number(inp.value);
...
if (document.querySelector('.main-block__slider')) {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.main-block__slider', {
    ...
    on: {
      init: function init(swiper) {
        ...
        allSlides.innerHTML = allSlidesItems.length < 10 ? "0".concat(allSlidesItems.length) : swiper.slides.length;
      },
      slideChange: function slideChange(swiper) {
        var currentSlides = document.querySelector('.fraction-controll__current');
        currentSlides.innerHTML = swiper.realIndex + 1 < 10 ? "0".concat(swiper.realIndex + 1) : swiper.realIndex + 1;
        console.log(swiper);
      }
    }
  });
...
if (document.querySelector('.images-product-block')) {
  var thumbsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.thumbs-images', {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Parallax, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs],
    watchOverflow: true,
    slidesPerView: 4,
    spaceBetween: 16,
    observer: true,
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.images-product-block-slider__slider', {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Parallax, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs],
    autoplay: {
      delay: 3000,
      disableOnInteraction: false
...
function useDynamicAdapt() {
  ...
  dMediaQueries.forEach(function (dMediaQuery) {
    var matchMedia = window.matchMedia(dMediaQuery.query); // массив объектов с подходящим брейкпоинтом
...
var rangeItems = document.querySelectorAll('[data-range]');
...
if (rangeItems.length) {
  rangeItems.forEach(function (rangeItem) {
    ...
    var item = rangeItem.querySelector('[data-range-item]');
  ...
  function setRating(rating) {
    ...
    var _loop = function _loop(_index) {
      ...
      ratingItem.addEventListener('mouseenter', function (e) {
        ...
        initRatingVars(rating); // Обновление активных звёзд
      ...
      ratingItem.addEventListener('click', function (e) {
        ...
        if (rating.dataset.ajax) {
          ...
          setRatingValue.innerHTML = _index + 1;
          setRatingActiveWidth();
        }
      });
    };
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              rating.classList.add('rating-sending'); // Отправка данных (value) на сервер

              _context.next = 4;
              return fetch('../json/rating.json', {
            ...
            case 8:
              ...
              ratingValue.innerHTML = newRating; // Обновление активных звёзд

              setRatingActiveWidth(); // rating.classList.remove('rating-sending');
...
if (spollersArray.length > 0) {
  ...
  if (spollersMedia.length > 0) {
    ...
    spollersMedia.forEach(function (item) {
      var param = item.dataset.spollers;
      var breakpoint = {};
    ...
    mediaQueries.forEach(function (breakpoint) {
      var paramArray = breakpoint.split(',');
      var mediaBreakpoint = paramArray[1];
      var mediaType = paramArray[2];
      var matchMedia = window.matchMedia(paramArray[0]); // Объекты с нужными условиями
